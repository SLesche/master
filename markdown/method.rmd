...
We use MATLABs _fminbnd_ function to find the optimal transformation parameter $b_j$ maximizing $r_{st}$. This function will estimate the objective function for all values inside the given bounds $b_j \in [0.5, 2]$ and converge on the global optimum. Hence, we do not need to initialize a number of different starting points here.
