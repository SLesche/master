...
abstract: |
  ...
  This work introduces a novel algorithm for latency extraction based on template matching. The algorithm uses the grand average to generate an experiment-specific template of the component of interest and then matches transformations of that template to subject-level ERPs. These transformations allow quantification of individual differences in latency.
